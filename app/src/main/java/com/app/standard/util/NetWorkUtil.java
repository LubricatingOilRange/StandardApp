...
import com.app.standard.app.StandardApplication;
...
public class NetWorkUtil {
    ...
    public static boolean isWifi() {
        ConnectivityManager connectivityManager = (ConnectivityManager) StandardApplication.getInstance().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static boolean isConnected() {
        ConnectivityManager mConnectivityManager = (ConnectivityManager) StandardApplication.getInstance().getSystemService(Context.CONNECTIVITY_SERVICE);
